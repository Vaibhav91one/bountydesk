  ...
  return (
    <Tabs defaultValue="scope" className="gap-6">
      ...
      <TabsContent value="general" className="flex flex-col gap-4">
        ...
        <Panel
          title="Agent harness"
          detail="The five things TrueForge holds: model providers, connectors, skills, the sandbox provider and the saved agent. A fresh harness has none of them, and the agent manifest will not apply until a model provider and a sandbox provider exist."
        >
          <Link href="/settings/harness" className="text-body text-foreground underline underline-offset-4">
